...
function  FPC_QApplication_Create: Pointer; cdecl; external fpc_qt5Lib name 'xx';
procedure FPC_QApplication_Destroy; cdecl; external fpc_qt5Lib name '';

constructor QApplication.Create;
begin
  FClassPtr := FPC_QApplication_Create;
...
begin
  FPC_QApplication_Destroy(FClassPtr);
end;
